<?php
	...
	/* Configuration */
	$subject = 'Hail Claim Lawyer - Middle Page Submission'; // Set email subject line here
	...
	$phone = $_POST['middle-optin-message'];
	$timestamp = date("F jS Y, h:iA.", time());

	// HTML for email to send submission details
	$body = "
	<br>
	<p>SHail Claim Lawyer - Middle Page Submission</p>
	...
	<div class=\"middle-optin\">
		<div class=\"row\">
			...
			<div class=\"form-group col-lg-3\">
				<input name=\"middle-optin-message\" id=\"middle-optin-message\" type=\"text\" class=\"form-control\" placeholder=\"How Can we Help?\">
			</div>
			<div class=\"form-group col-lg-3\">
				<button type=\"submit\" class=\"btn btn-default black-btn\">FREE CASE REVIEW</button>
			</div>
		</div>
	</div>
	<div class=\"row\">
	...
	<div class=\"alert alert-success\">
		...
		<strong>Thank You!</strong> Thank you for your submission! We will be in contact shortly.
	</div>
	";
